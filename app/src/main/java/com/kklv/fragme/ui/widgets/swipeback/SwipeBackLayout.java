package com.kklv.fragme.ui.widgets.swipeback;
...
public class SwipeBackLayout extends FrameLayout {
     ...
     */
    private static final float DEFAULT_SCROLL_RATIO = 0.20f;
    ...
    private class ViewDragCallback extends ViewDragHelper.Callback {
        ...
        public void onViewReleased(View releasedChild, float xVel, float yVel) {
            ...
            boolean res = false;
            float time = (touchUpTime - touchDownTime) / 1000f;
            if (mScrollPercent >= DEFAULT_SCROLL_RATIO) {
                res = true;
            } else if (mScrollPercent >= 0.15f && time < 0.5) {
                res = true;
            }
            int left = xVel >= 0 && res ? childWidth
